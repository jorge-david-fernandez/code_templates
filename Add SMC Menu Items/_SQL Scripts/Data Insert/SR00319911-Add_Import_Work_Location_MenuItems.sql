...
-- EXAMPLE #1
-- In this example, we're creating a Summary/List page that will be displayed as a tab under the "Jobs" tabset, under "Myself", "My Team", and "Employee Admin"
-- And, creating the add/change page, as an Action item, but subsidiary to the list/summary page.
	
EXEC dbo.U_WebCustoms_AddMenuElement
	@ElementLabel     = 'Import Employee Locations',
	@ElementType      = 'Action',
	@ParentPath       = 'Payroll Processing > Payroll Gateway > Payroll Gateway > Payroll Overview',
	@ReferencePath    = 'Payroll Processing > Payroll Gateway > Payroll Gateway > Payroll Overview > View Pending Pay Items Status History',
	@EditOrViewFolder = 'EDIT',
	@AspxFilename     = 'ImportWorkLocations.aspx',
	@AllowableRights  = 'CREATE,READ,UPDATE,DELETE'
	
/*
UNDO:

EXEC dbo.U_WebCustoms_RemoveMenuElement 'Myself > Jobs > Bonus Target Percent > Add/Change Bonus Target Percent'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'My Team > My Employees > (Employee Popup) > Jobs > Bonus Target Percent > Add/Change Bonus Target Percent'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'Employee Admin > My Employees > (Employee Popup) > Jobs > Bonus Target Percent > Add/Change Bonus Target Percent'

EXEC dbo.U_WebCustoms_RemoveMenuElement 'Myself > Jobs > Bonus Target Percent'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'My Team > My Employees > (Employee Popup) > Jobs > Bonus Target Percent'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'Employee Admin > My Employees > (Employee Popup) > Jobs > Bonus Target Percent'
*/

-- EXAMPLE #2
-- Creating a menu group tabset under System Admin after "Deduction Goal Update"
-- "System Admin > Custom Import"  (menu item)
-- "System Admin > Custom Import > Configuration" (page)
-- "System Admin > Custom Import > Results" (page)
	
/*
UNDO:
EXEC dbo.U_WebCustoms_RemoveMenuElement 'System Admin > Custom Import > Results'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'System Admin > Custom Import > Configuration'
EXEC dbo.U_WebCustoms_RemoveMenuElement 'System Admin > Custom Import'
*/
